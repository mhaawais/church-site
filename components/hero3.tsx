    ...
    <section className="relative bg-[#8E8E8E] py-14 px-4 sm:px-6">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-white text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight font-serif">
            Books You&apos;ll Love
          </h2>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-white/70 text-sm sm:text-base leading-relaxed">
            Explore the latest releases and bestselling titles from the Grace
            Revelations series. Tap a cover to view details, or grab your copy
            today.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {books.map((book, index) => (
            ...
            >
              ...
              {/* Book Title */}
              <h3 className="mt-4 text-sm font-bold text-white truncate">
                {book.title}
              </h3>
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-myred px-5 py-2.5 text-xs font-bold bg-red-700 text-white transition-all duration-300 hover:bg-red-800 hover:scale-[1.03] hover:ring-1 hover:ring-white/60"
                >
                  Buy Now
                </a>
              </div>
        ...
        <div className="mt-14 text-center">
          <Link
            href="/books"
            className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-7 py-3 text-sm font-extrabold text-slate-900 hover:bg-white/90 transition"
          >
            Browse All Books
